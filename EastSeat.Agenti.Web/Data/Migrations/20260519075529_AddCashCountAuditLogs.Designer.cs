...
namespace EastSeat.Agenti.Web.Data.Migrations
{
    ...
    [Migration("20260519075529_AddCashCountAuditLogs")]
    partial class AddCashCountAuditLogs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.AppConfig", b =>
                {
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.CashCount", b =>
                {
                    ...
                    b.HasIndex("CashSessionId", "AgentId", "IsOpening")
                        .IsUnique();

                    b.ToTable("CashCounts");
                });

            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.CashCountAuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CashCountId", "PerformedAt");

                    b.HasIndex("CashSessionId", "PerformedAt");

                    b.ToTable("CashCountAuditLogs");
                });
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.TransactionFlag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TransactionId", "FlaggedByUserId");

                    b.ToTable("TransactionFlags");
                });

            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.Vault", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.VaultTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.WalletAdjustment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EastSeat.Agenti.Web.Data.UserAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.CashCountAuditLog", b =>
                {
                    ...
                    b.HasOne("EastSeat.Agenti.Web.Data.ApplicationUser", "PerformedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.CashSession", b =>
                {
                    b.HasOne("EastSeat.Agenti.Shared.Domain.Entities.Branch", "Branch")
                        .WithMany()
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.Notification", b =>
                {
                    b.HasOne("EastSeat.Agenti.Web.Data.ApplicationUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EastSeat.Agenti.Web.Data.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.TransactionFlag", b =>
                {
                    b.HasOne("EastSeat.Agenti.Web.Data.ApplicationUser", "FlaggedByUser")
                        .WithMany()
                        .HasForeignKey("FlaggedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EastSeat.Agenti.Web.Data.ApplicationUser", "ResolvedByUser")
                        .WithMany()
                        .HasForeignKey("ResolvedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EastSeat.Agenti.Shared.Domain.Entities.Transaction", "Transaction")
                        .WithMany()
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.Vault", b =>
                {
                    b.HasOne("EastSeat.Agenti.Shared.Domain.Entities.Branch", "Branch")
                        .WithOne("Vault")
                        .HasForeignKey("EastSeat.Agenti.Shared.Domain.Entities.Vault", "BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EastSeat.Agenti.Shared.Domain.Entities.VaultTransaction", b =>
                {
                    ...
                    b.HasOne("EastSeat.Agenti.Web.Data.ApplicationUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EastSeat.Agenti.Shared.Domain.Entities.Vault", "Vault")
                        .WithMany("Transactions")
